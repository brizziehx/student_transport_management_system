    ...
    <main class="home grid">
        ...
        <div class="cards grid">
            ...
            <div href="#" class="card xxxpand">
                ...
                <p class="flex"><b>All Buses</b><a href="addbus.php"><i class="bx bx-bus-school icon"></i></a></p>
                <?=$_SESSION['msg'] ?? '' ?>
                    ...
                    <?php
                        ...
                        while($row = $result->fetch_array()){ ?>
                            <tr>
                                ...
                                <td><?=$row['routeID']?></td>
                                <td>
                                    <a class=btn-edit onclick="if(confirm('Are you sure you want to edit this route?') === false) { event.preventDefault() }" href=editbus.php?busID=<?=$row['busID']?>><i class="bx bx-edit icon"></i></a>
                                    <a class=btn-delete onclick="if(confirm('Are you sure you want to delete this route?') === false) { event.preventDefault() }" href=deletebus.php?busID=<?=$row['busID']?>><i class="bx bx-trash icon"></i></a>
                                </td>
                                </tr>
                         <?php   }
                        $conn->close();
