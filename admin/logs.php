    ...
    <main class="home grid">
        ...
        <?php
            ...
            if(isset($_POST['searchTerm'])):
                ...
                $select = $conn->query("SELECT * FROM users WHERE firstname LIKE '%{$name}%' OR lastname LIKE '%{$name}%' OR email LIKE '%{$name}%'");
                if($select->num_rows > 0): ?>
                    <div class="cards grid">
                        ...
                        <p class="flex"><b>Logs</b><i class="bx bx-task icon"></i></p>
                            <?=$_SESSION['msg'] ?? '' ?>
        ...
        <?php   else: ?>
                <div class="cards grid">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" aria-current="page"><a href="index.php">Dashboard </a></li>
                        <li class="breadcrumb-item active" aria-current="page">No Logs</li>
                    </ol>
                </nav>
                <p class="flex"><b>Logs</b><i class="bx bx-task icon"></i></p>
            ...
            <div href="#" class="card xxxpand">
                ...
                <table>
                    ...
                    <?php
                        ...
                        $result = $conn->query("SELECT * FROM users LIMIT $offset, $total_records_per_page");
