                        ...
                        <?php
                            ...
                            while($row = $result->fetch_array()){
                                ...
                                if($routetaken['name'] == NULL) {
                                    $routeTkn = "<span style='color: crimson'>Not yet assigned</span>";
                                } else {
                                    $routeTkn = $routetaken['name'];
                                }

                                if($busDriver['busID'] == NULL) {
                                    $busID = "<span style='color: crimson'>Not yet assigned</span>";
                                } else {
                                ...
                                echo "<tr>
                                        ...
                                        <td>".$routeTkn."</td>
                                        <td>" ?>
                                            <?php if($row['usertype'] === 'User' || $row['usertype'] === 'Driver'): ?>
                                                <?php if(!empty($busDriver['busID']) && !empty($busDriver['driverID'])): ?>
                                                    <a class=btn-edit onclick="if(confirm('Are you sure you want to assign route fot this driver?') === false) { event.preventDefault() }" href=assign.php?id=<?=$row['userID']?>><i class="bx bx-trip icon"></i></a>
                                                <?php endif ?>
                                        </td>
                                        <td>
                                                <a class=btn-delete onclick="if(confirm('Are you sure you want to delete this driver?') === false) { event.preventDefault() }" href=delete.php?id=<?=$row['userID']?>><i class="bx bx-trash icon"></i></a>
                                            <?php endif ?>
                                        </td>
                                    </tr>
                            <?php   }
