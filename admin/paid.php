<?php 
    ...
    $result_count = $conn->query("SELECT COUNT(*) As total_records FROM student  WHERE EXISTS(SELECT studentID FROM payment WHERE student.studentID = payment.studentID AND month(date) = month(now()))");
        ...
        <div class="cards grid">
            ...
            <div href="#" class="card xxxpand">
                <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">All Paid Students</li>
                    </ol>
                </nav>
                ...
                <table>
                    ...
                    <?php
                            ...
                            $result = $conn->query("SELECT student.studentID, student.firstname, student.lastname, student.parentName, stop.locationName FROM student INNER JOIN stop ON student.locationID = stop.locationID WHERE EXISTS(SELECT studentID FROM payment WHERE student.studentID = payment.studentID AND month(date) = month(now()) AND year(date) = year(now())) LIMIT $offset, $total_records_per_page");
